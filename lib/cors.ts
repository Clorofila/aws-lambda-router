...
const configureOrigin = (options: CorsOptions, event: APIGatewayProxyEventV2): HeaderObject => {
...
const configureAllowedHeaders = (options: CorsOptions, event: APIGatewayProxyEventV2): HeaderObject => {
...
export const addCorsHeaders = (options: CorsOptions | boolean, event: APIGatewayProxyEventV2) => {
    if (options === false) {
        return {};
    }
