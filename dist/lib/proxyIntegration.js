...
const process = (proxyIntegrationConfig, event, context) => {
    ...
    const headers = proxyIntegrationConfig.cors
    ...
    try {
        ...
        const actionConfig = findMatchingActionConfig(httpMethod, event.requestContext.http.path, proxyIntegrationConfig) || {
...
const normalizeRequestPath = (event, removeBasePath = true) => {
